...
The RailManager class is a friend class of Graph, allowing it to access its private members.
*/
    friend class RailManager;
    /**

The App class is a friend class of Graph, allowing it to access its private members.
*/
    friend class App;
};
